...
import spring.boot.base.entity.SysPermission;
import spring.boot.base.entity.SysRole;
...
public class UserDao {
    ...
    public SysUser selectByName(String username) {
        ...
        if ("zhangsan".equals(username)) {
            SysUser sysUser = new SysUser("zhangsan", "$2a$10$EK.mXoxTJyeP1h87N/Bs1.qwqf/ALNDC77xCEt2Nd06LUDzU2/KsO");
            sysUser.setRoleList(Arrays.asList(admin, developer));
            return sysUser;
        }else if ("lisi".equals(username)) {
            SysUser sysUser = new SysUser("lisi", "$2a$10$EK.mXoxTJyeP1h87N/Bs1.qwqf/ALNDC77xCEt2Nd06LUDzU2/KsO");
    ...
    public static void main(String[] args) {
    	...
    	//$2a$10$EK.mXoxTJyeP1h87N/Bs1.qwqf/ALNDC77xCEt2Nd06LUDzU2/KsO
